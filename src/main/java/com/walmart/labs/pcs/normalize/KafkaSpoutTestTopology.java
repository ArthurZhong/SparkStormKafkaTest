...
public class KafkaSpoutTestTopology {
    ...
    public static class PrinterBolt extends BaseBasicBolt {
        ...
        public void execute(Tuple tuple, BasicOutputCollector collector) {
            System.out.println("test print:" + tuple.getString(0));
            System.out.println("test printing:" + tuple.getValues().get(0).toString());
        }
    ...
    /*
     * input is the kafka zookeeper server address including port number
     */
